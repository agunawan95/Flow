...
// "colorize" the widget name
    $.widget("flowchart.flowchart", {
        ...
        options: {
            ...
            defaultLinkColor: '#00AA7F',
            defaultSelectedLinkColor: '#D71B32',
            linkWidth: 10,
            grid: 20,
        ...
        _getOperatorFullElement: function (operatorData) {
            ...
            var $operator = $('<div class="flowchart-operator" id="' + infos.key + '"></div>');
            ...
            var $operator_img = $('<img src="/static' + infos.img + '" class="custom-component-icon custom-view-icon">');
            var $operator_img_container = $('<div class="custom-icon-container"></div>');
            $operator_img.appendTo($operator_img_container);
            $operator_img_container.appendTo($operator_inputs_outputs);
